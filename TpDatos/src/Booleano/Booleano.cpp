...
void Booleano::terminoEncontrado(string palabraStr,int *i, bool *encontrado){
	...
	ifstream archivoTerminos (PATH_ARCHIVO_TERMINOS_BOOLEANO,ios::binary);  //archivo de terminos por orden de aparicion.
	*encontrado = false;
...
void Booleano::agregar_a_archivoT (string palabra, int *offset){
	...
	ofstream archivoTerminos (PATH_ARCHIVO_TERMINOS_BOOLEANO,ios::binary | ios::app);  //archivo de terminos por orden de aparicion.
...
string Booleano::obtenerTermino (int idT){
	...
	char longitud;
	ifstream archivoT (PATH_ARCHIVO_TERMINOS_BOOLEANO,ios::binary);
    string term;
