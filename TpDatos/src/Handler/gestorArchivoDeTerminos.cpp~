/*
 * gestorArchivoDeTerminos.cpp
 *
 *  Created on: 21/11/2012
 *      Author: francisco
 */

#include "gestorArchivoDeTerminos.h"

gestorArchivoDeTerminos::gestorArchivoDeTerminos(string rutaArchivo) {
...
gestorArchivoDeTerminos::~gestorArchivoDeTerminos() {

}

void gestorArchivoDeTerminos::agregarTermino(string palabra) {
...
int gestorArchivoDeTerminos::buscarPosicionTermino(string palabraAbuscar) {
...
int gestorArchivoDeTerminos::getCantidadElementos() {
	return cantidadTerminos;
}

void gestorArchivoDeTerminos::putCantidadElementos(int numeroTerminos) {
	this->cantidadTerminos = numeroTerminos;
}

void gestorArchivoDeTerminos::aumentarCantidadElementos() {
