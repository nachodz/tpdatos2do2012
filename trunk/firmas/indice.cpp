...
indice::indice(string rutaLexico, string rutaTerminos,string rutaOcurrencias, string rutaPorciones,int tamanioFirma) {
	...
	this->gestorArchivoTerminos = new gestorArchivoDeTerminos(rutaTerminos);
	this->gestorArchivoDeOcurrencias = new gestorArchivoOcurrencias(rutaOcurrencias);
	this->gestorArchivoDePorciones = new gestorArchivoPorciones(rutaPorciones);
