...
#define PATH_TERMINOS "terminos.dat"
#define PATH_OCURRENCIAS "ocurrencias.dat"
#define PATH_FRASES "Frases_Celebres.dat"
#define PATH_INDICE "config.dat"
#define PATH_FRASES_EN_TXT "Listado_frases.txt"
#define PATH_RESULTADO_BUSQUEDA "resutado_busqueda.txt"
...
#define TAM_BUFFER_SORT 50
#define CANT_PARTICIONES 50
