...
NodoInterno::NodoInterno(int nivel) : Nodo(nivel) {
...
Persistencia NodoInterno::serializar() {
	Persistencia cadena;
/*
...
bool NodoInterno::hidratar(Persistencia & cadena) {
	bool exito = true;
...
//************Getters y Setters****************
int* NodoInterno::getHijos(){
	return this->hijos;
}

void NodoInterno::setHijos(int* hijos){
	this->hijos = hijos;
}
